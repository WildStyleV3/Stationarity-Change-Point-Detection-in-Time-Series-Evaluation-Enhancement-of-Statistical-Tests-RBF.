...
## Parámetros del modelo logístico de hormigas
K_pop <- 1000   # capacidad de carga (máx hormigas)
r_pop <- 0.2   # tasa de crecimiento
N0    <- 10     # población inicial

A <- (K_pop - N0) / N0

# Tendencia g(t) = solución de la EDO logística
g <- K_pop / (1 + A * exp(-r_pop * t))
